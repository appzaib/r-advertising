...
<footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-between">
        ...
        <div className="grid grid-cols-1 gap-4 pl-10 sm:gap-6 sm:grid-cols-3 lg:grid-cols-2">
            <Link href="https://flowbite.com/" className="flex items-center">
                {/* <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 mr-3" alt="FlowBite Logo" /> */}
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">R | Advertising</span>
            </Link>
        </div></div>
        <div className="grid grid-cols-2 gap-6 sm:gap-6 sm:grid-cols-3 lg:grid-cols-4">
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Resources</h2>
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <Link href="https://raoahmad.com/" className="hover:underline">Raoahmad</Link>
                    </li>
                    <li>
                        <Link href="https://appzaib.com/" className="hover:underline">Appzaib</Link>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <Link href="https://github.com/themesberg/Appzaib" className="hover:underline ">Github</Link>
                    </li>
                    <li>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link href="https://flowbite.com/" className="hover:underline">R | Advertising™</Link>. All Rights Reserved.
        </span>
