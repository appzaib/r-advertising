        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col w-full mb-20 text-center">
            ...
            <p className="mx-auto text-lg leading-relaxed lg:w-2/3">
              Statics that define our success story.
            </p>
          </div>
          {/*   cards main containter */}
          <div className="flex flex-wrap items-center justify-center m-4 text-center ">
            {/* card */}
            <div className="w-full p-4 duration-1000 md:w-1/4 sm:w-1/2 hover:translate-x-7 ">
              <div className="px-4 py-6 border-2 border-gray-200 rounded-lg shadow-lg">
                <svg
                  fill="none"
                  stroke="currentColor"
                  strokeLinecap="round"
            ...
            <div className="w-full p-4 duration-1000 md:w-1/4 sm:w-1/2 hover:translate-x-7 ">
              <div className="px-4 py-6 border-2 border-gray-200 rounded-lg shadow-lg">
                ...
                <p className="leading-relaxed">Repeating</p>
              </div>
            </div>
            <div className="w-full p-4 duration-1000 md:w-1/4 sm:w-1/2 hover:translate-x-7 ">
              <div className="px-4 py-6 border-2 border-gray-200 rounded-lg shadow-lg ">
                ...
                <p className="leading-relaxed">satisfied</p>
              </div>
            </div>
          </div>
        </div>
